    ...
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="text-center xl:flex xl:items-center xl:justify-between xl:text-left">
            <div className="xl:flex xl:items-center xl:justify-start">
                <h2 className="text-2xl font-bold text-white font-poppins">Interview Trainer</h2>
                <a href="https://github.com/saiteja-in" className="mt-5 text-sm text-white xl:ml-6 xl:mt-0">© Copyright {new Date().getFullYear()} Team</a>
            </div>
